...
# Check if AI Notes Generated tag exists
print("Checking if 'AI Notes Generated' tag exists in CATS...")
...
if response.status_code == 200:
    ...
    if '_embedded' in data:
        ...
        ai_tag = None
        for tag in tags:
            if tag.get('title') == 'AI Notes Generated':
                ai_tag = tag
                break
        ...
        if ai_tag:
            ...
            print("❌ Tag 'AI Notes Generated' does NOT exist in CATS")
